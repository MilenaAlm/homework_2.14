...
public class StringListIImpl implements StringList {
    private static final int DEFAULT_INITIAL_CAPACITY = 10;
    private final String[] data;
    private int size;

    public StringListIImpl() {
        this(DEFAULT_INITIAL_CAPACITY);
    }

    public StringListIImpl(int initialCapacity) {
    ...
    private void checkIndex (int index, boolean include){
        ...
        if (index < 0 || !checkUpperBound){
            throw new IllegalArgumentException("Выход за границы индекса!");
